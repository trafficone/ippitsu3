...
"""
    ...
    Documentation http://daily.profeth.de/2008/04/using-recaptcha-with-google-app-engine.html
    Available at https://code.google.com/p/lontarblog/source/browse/trunk/recaptcha.py
